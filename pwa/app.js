...
const translations = {
  cs: {
    ...
    cancel: "Zrusit",
    delete: "Smazat",
    dailyProgress: "Denni progres",
    streak: "Streak",
    completedOf: "{completed} z {total}",
    todayEmpty: "Na dnesek zatim nic nemas.",
    tasksEmpty: "Pridej prvni opakovany nebo jednorazovy ukol.",
    language: "Jazyk",
    appearance: "Vzhled",
    light: "Svetly",
    dark: "Tmavy",
    ...
    notificationReady: "Notifikace jsou povolene.",
    localOnly: "Data jsou ulozena jen v tomto zarizeni.",
    sunday: "Ne",
    monday: "Po",
    tuesday: "Ut",
    wednesday: "St",
    ...
    friday: "Pa",
    saturday: "So",
    bestTasks: "Nejlepsi ukoly",
    worstTasks: "Nejslabsi ukoly",
    bestDay: "Nejlepsi den",
    worstDay: "Nejslabsi den",
    recommendation: "Doporuceni",
    noRecap: "Recap se objevi, az bude v tydnu co vyhodnotit.",
    noTasks: "Naplan si par ukolu na dalsi tyden.",
    excellent: "Skvely tyden. Drz stejny rytmus.",
    focusWeakTask: "Zkus zjednodusit nejslabsi ukol nebo mu dat pevny cas.",
    steady: "Jdes dobre. Zamer se na jeden ukol, ktery nejcasteji unika.",
    addOneTimeToday: "Jednorazovy na dnes",
    installHint: "Pridat na plochu",
    pwaLimit: "PWA notifikace jsou demo rezim; pro presne budiky je lepsi pozdejsi iOS build.",
    taskTime: "Cas na ukol",
    weeklyRecap: "Tydenni recap"
  },
  en: {
    appName: "Daily Tracker Pro",
    today: "Today",
